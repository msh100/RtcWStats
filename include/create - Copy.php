...
else
{
	...
	echo "<div class='shortcuts'><a href='#overallstats'>Overall Stats</a> | <a href='#awards'>Awards</a> | <a href='#weapons'>Weapon Stats</a> | <a href='#players'>Player Stats</a> | <a href='#osptotalstats'>OSP Total Stats</a> | <a href='#osproundstats'>OSP Round Stats</a> | <a href='#chatlog'>Chat Log</a></div>\n";
	$analyzer = new StatsAnalyzer($_FILES["logfile"]["tmp_name"]);
	echo "<h1><a name='overallstats'>&nbsp;</a>Overall Stats</h1>\n";
	$analyzer->PrintStats("custom");
